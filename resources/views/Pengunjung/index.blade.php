...
<head>
    ...
    <title>SWISS | pengunjung mayur</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-mini"><b>pengunjung</b></span>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">pengunjung mayur</li>
            </ol>
        </section>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        @endif
                                        <a href="{{route('pengunjung.create')}}" class="btn btn-info pull-right">Tambah Data</a><br><br>
                                        <table class="table table-striped">
                                            ...
                                            @foreach($pengunjungs as $pengunjung)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="POST" action="{{ route('pengunjung.destroy', $pengunjung->id) }}" accept-charset="UTF-8">
                                                            <input name="_method" type="hidden" value="DELETE">
                                                            <input name="_token" type="hidden" value="{{ csrf_token() }}">
                                                            <a href="{{route('pengunjung.edit', $pengunjung->id)}}" class="btn btn-primary">Edit</a>
                                                            <a href="{{route('pengunjung.show', $pengunjung->id)}}" class="btn btn-warning">Lihat</a>
