...
<head>
    ...
    <title>SWISS | jagung mayur</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-mini"><b>jagung</b></span>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">jagung mayur</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <form action="{{route('jagung.show', $jagungs->id)}}" method="post">
                                            ...
                                            <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $jagungs->nama;?></label>
                                                {!! $errors->first('nama', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('family') ? ' has-error' : '' }}">
                                                <label class="col-sm-2 control-label">Family</label>
                                                <label class="control-label"> : <?php echo $jagungs->family;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('tanggal_tanam') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $jagungs->tanggal_tanam;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('usia') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $jagungs->usia;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('hama') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $jagungs->hama;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('syarat_tumbuh') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $jagungs->syarat_tumbuh;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('pemeliharaan') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $jagungs->pemeliharaan;?></label>
                    ...
                    <h3> Scroll untuk menyiram jagung</h3>
