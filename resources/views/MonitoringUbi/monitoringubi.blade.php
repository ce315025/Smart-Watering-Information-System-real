                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        @endif
                                        <a href="{{route('ubi.create')}}" class="btn btn-info pull-right">Tambah Data</a><br><br>
                                        <table class="table table-striped">
                                            ...
                                            @foreach($ubis as $ubi)
                                                <tr>
                                                    <td>{{$no++}}</td>
                                                    <td><img src="<?php echo asset("image/$ubi->foto")?>" style="max-height:40px; max-width: 40px; margin-top:10px;" /> </img> </td>
                                                    <td>{{$ubi->nama}}</td>
                                                    <td>{{$ubi->family}}</td>
                                                    <td>{{$ubi->tanggal_tanam}}</td>
                                                    <td>{{$ubi->usia}}</td>
                                                    <td>{{$ubi->hama}}</td>
