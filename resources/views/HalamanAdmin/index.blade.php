...
<div class="wrapper">
      ...
      <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <a href="{{URL::to('/monitoring')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
          </div>
        <!-- ./col -->
          <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <a href="{{URL::to('/pengunjung')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
          </div>
        <!-- ./col -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                  ...
                  <div class="info-box-content">
                      <span class="info-box-text">Perawatan</span>
                      <span class="info-box-number">760</span>
                  </div>
                <a href="{{URL::to('/jadwal')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
          </div>
        <!-- ./col -->
          <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                  ...
                  <div class="info-box-content">
                      <span class="info-box-text">Hot News</span>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016-2017 32TK07PA2-1617</strong>
  </footer>
