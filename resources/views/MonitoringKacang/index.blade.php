                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        @endif
                                        <a href="{{route('kacang.create')}}" class="btn btn-info pull-right">Tambah Data</a><br><br>
                                        <table class="table table-striped">
                                            ...
                                            <?php $no=1; ?>
                                            @foreach($kacangs as $kacang)
                                                <tr>
                                                    <td>{{$no++}}</td>
                                                    <td><img src="<?php echo asset("image/$kacang->foto")?>" style="max-height:40px; max-width: 40px; margin-top:10px;" /> </img> </td>
                                                    <td>{{$kacang->nama}}</td>
                                                    <td>{{$kacang->family}}</td>
                                                    <td>{{$kacang->tanggal_tanam}}</td>
                                                    <td>{{$kacang->usia}}</td>
                                                    <td>{{$kacang->hama}}</td>
