...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">tomat mayur</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="callout callout-info">
                ...
                <p>Anda dapat melihat detail dari tanaman yang tersedia dan juga melakukan penyiraman secara otomatis dengan mengklik more</p>
            </div>
            <!-- Default box -->
            <div class="box">
                ...
                <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <form action="{{route('tomat.show', $tomats->id)}}" method="post">
                                            <input name="_method" type="hidden" value="PATCH">
                                            {{csrf_field()}}
                                            <div class="form-group{{ $errors->has('foto') ? ' has-error' : '' }}">
                                                <label class="col-sm-2 control-label">Foto</label>
                                                <label class="control-label"> : <td><img src="<?php echo asset("image/$tomats->foto")?>" style="max-height:40px; max-width: 40px; margin-top:10px;" /> </img> </td></label>
                                                {!! $errors->first('foto', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                                                <label class="col-sm-2 control-label">Nama</label>
                                                <label class="control-label"> : <?php echo $tomats->nama;?></label>
                                                {!! $errors->first('nama', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('family') ? ' has-error' : '' }}">
                                                <label class="col-sm-2 control-label">Family</label>
                                                <label class="control-label"> : <?php echo $tomats->family;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('tanggal_tanam') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $tomats->tanggal_tanam;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('usia') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $tomats->usia;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('hama') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $tomats->hama;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('syarat_tumbuh') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $tomats->syarat_tumbuh;?></label>
                                            ...
                                            <div class="form-group{{ $errors->has('pemeliharaan') ? ' has-error' : '' }}">
                                                ...
                                                <label class="control-label"> : <?php echo $tomats->pemeliharaan;?></label>
                    ...
                    <h3> Scroll untuk menyiram tomat</h3>
    ...
    <footer class="main-footer">
        ...
        <strong><center>Copyright &copy; 32TK07PA2-1617</a>.</center></strong>
    </footer>
