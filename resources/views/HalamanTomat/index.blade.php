                    ...
                    @extends('master')
                        ...
                        <div class="row">
                            <table class="table table-striped">
                                ...
                                <a href="{{route('tomat.create')}}" class="btn btn-info pull-right">Create New Data</a><br><br>
                                <?php $no=1; ?>
                                @foreach($tomats as $tomat)
                                    <tr>
                                        <td>{{$no++}}</td>
                                        <td><img src="<?php echo asset("image/$tomat->images")?>" style="max-height:40px; max-width: 40px; margin-top:10px;"> </img> </td>
                                        <td>{{$tomat->nama}}</td>
                                        <td>{{$tomat->family}}</td>
                                        <td>{{$tomat->tanggal_tanam}}</td>
                                        <td>{{$tomat->usia}}</td>
                                        <td>{{$tomat->hama}}</td>
                                        <td><form class="" action="{{route('tomat.destroy',$tomat->id)}}" method="post">
