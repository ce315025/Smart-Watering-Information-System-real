                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="{{route('HalamanMonitoring.update', $sayurs->id)}}" method="post">
                                            ...
                                            <div class="form-group{{ $errors->has('family') ? ' has-error' : '' }}">
                                                <input type="text" name="family" class="form-control" placeholder="Family" value="{{$sayurs->family}}">
                                                {!! $errors->first('family', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('tanggal_tanam') ? ' has-error' : '' }}">
                                                <input type="text" name="tanggal_tanam" class="form-control" placeholder="Tanggal Tanam" value="{{$sayurs->tanggal_tanam}}">
                                                {!! $errors->first('tanggal_tanam', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('usia') ? ' has-error' : '' }}">
                                                <input type="text" name="usia" class="form-control" placeholder="Usia" value="{{$sayurs->usia}}">
                                                {!! $errors->first('usia', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('hama') ? ' has-error' : '' }}">
                                                <input type="text" name="hama" class="form-control" placeholder="Hama" value="{{$sayurs->hama}}">
                                                {!! $errors->first('hama', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('syarat_tumbuh') ? ' has-error' : '' }}">
                                                <input type="text" name="syarat_tumbuh" class="form-control" placeholder="Syarat Tumbuh" value="{{$sayurs->syarat_tumbuh}}">
                                                {!! $errors->first('syarat_tumbuh', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('pemeliharaan') ? ' has-error' : '' }}">
                                                <input type="text" name="pemeliharaan" class="form-control" placeholder="Pemeliharaan" value="{{$sayurs->pemeliharaan}}">
