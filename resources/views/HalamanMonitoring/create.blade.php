                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <form action="{{route('HalamanMonitoring.store')}}" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group{{ $errors->has('tanggal_tanam') ? ' has-error' : '' }}">
                                                <input type="date" name="tanggal_tanam" class="form-control" placeholder="Tanggal Tanam">
                                            ...
                                            <div class="form-group{{ $errors->has('hama') ? ' has-error' : '' }}">
                                                <input type="text" name="hama" class="form-control" placeholder="Hama">
                                                {!! $errors->first('hama', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('syarat_tumbuh') ? ' has-error' : '' }}">
                                                <textarea class="form-control" name="syarat_tumbuh"  placeholder="Syarat Tumbuh"></textarea>
                                                {!! $errors->first('syarat_tumbuh', '<p class="help-block">:message</p>') !!}
                                            </div>
                                            <div class="form-group{{ $errors->has('pemeliharaan') ? ' has-error' : '' }}">
                                                <textarea class="form-control" name="pemeliharaan"  placeholder="Pemeliharaan"></textarea>
                                                {!! $errors->first('pemeliharaan', '<p class="help-block">:message</p>') !!}
                                            </div>

                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary pull-right" value="post">Simpan</button>
                                            </div>
                                        </form>
