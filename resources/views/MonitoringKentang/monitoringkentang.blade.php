                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        @endif
                                        <a href="{{route('kentang.create')}}" class="btn btn-info pull-right">Tambah Data</a><br><br>
                                        <table class="table table-striped">
                                            ...
                                            <?php $no=1; ?>
                                            @foreach($kentangs as $kentang)
                                                <tr>
                                                    <td>{{$no++}}</td>
                                                    <td><img src="<?php echo asset("image/$kentang->foto")?>" style="max-height:40px; max-width: 40px; margin-top:10px;" /> </img> </td>
                                                    <td>{{$kentang->nama}}</td>
                                                    <td>{{$kentang->family}}</td>
                                                    <td>{{$kentang->tanggal_tanam}}</td>
                                                    <td>{{$kentang->usia}}</td>
                                                    <td>{{$kentang->hama}}</td>
